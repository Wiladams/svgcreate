...
--[[
    This file originated from the Ghostcript_tiger.svg file, which
    is a standard for SVG rendering, and can easily be found on 
    the internet (and in the images directory).

    Here, all the path data has been converted to the Lua form 
    so that the data can later be used for experiments in animation
    and element selection in general.

    In this particular file, we just render the .svg just like the
    original, demonstrating that you can faithfully recreate fairly
    involved .svg files using the Lua method.
]]
...
local doc = svg{
    ...
    g { id="g4", fill="none", transform="matrix(1.7656463,0,0,1.7656463,324.90716,255.00942)",
        ...
        g { id="g166", stroke_width="0.5", stroke="#000", fill="#FFC",
        ...
        g { id="g662", stroke_width="0.1", stroke="#000", fill="#FFF",
        ...
        g { id="g666", stroke_width="0.1", stroke="#000", fill="#FFF",
        ...
        g { id="g670", stroke_width="0.1", stroke="#000", fill="#FFF",
        ...
        g { id="g682", stroke_width="0.1", stroke="#000", fill="#FFF",
        ...
        g { id="g730", stroke_width="0.1", stroke="#000", fill="#FFF",
        ...
        g { id="g770", stroke_width="0.1", stroke="#000", fill="#FFF",
        ...
        g { id="g774", stroke_width="0.1", stroke="#000", fill="#FFF",
        ...
        g { id="g778", stroke_width="0.1", stroke="#000", fill="#FFF",
        ...
        g { id="g782", stroke_width="0.1", stroke="#000", fill="#FFF",
        ...
        g { id="g786", stroke_width="0.1", stroke="#000", fill="#FFF",
        ...
        g { id="g790", stroke_width="0.1", stroke="#000", fill="#FFF",
        ...
        g { id="g794", stroke_width="0.1", stroke="#000", fill="#FFF",
...
local ImageStream = svgstream(FileStream.open("test_tiger.svg"))
